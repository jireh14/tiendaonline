...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_formapago and try to insert new data
        config.model.insert_formapago(
            form['efectivo'],form['banco'],form['nom_titular'],form['num_cuenta'],form['num_tarjeta'],form['fecha_ven'],form['nip'],
        )
