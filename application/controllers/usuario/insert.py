...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_usuario and try to insert new data
        config.model.insert_usuario(
            form['nombre'],form['apellidos'],form['correo_usuario'],form['contrasena'],form['calle_num'],form['colonia'],form['codigo_postal'],form['ciudad'],form['estado'],form['referencias'],form['fecha_reg_usu'],form['status_user'],
        )
